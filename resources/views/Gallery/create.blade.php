                        ...
                        <div class="col-11">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('GalleryStore')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-12">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <input class="form-control txtOnly" type="text" name="ImageHeading" placeholder="Enter Image Heading" id="first_heading" required>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <input class="form-control txtOnly" type="text" name="ImageTitle" placeholder="Enter Image  Title" id="first_Title" required>
                                                    </div>
                                                </div> 
                                            </div>
                                        </div>
