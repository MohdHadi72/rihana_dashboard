                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('updateHome' , $homeData->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="file" class="form-control-file mt-2" id="first_image" name="HomeImg1">
                                                    @if($homeData->HomeImg1)
                                                    <div style="width: 100px; height: auto;" class="homeimage mt-3">
                                                        <img src="/productimage/{{ $homeData->HomeImg1 }}" style="width: 100%; border-radius: 10%;" alt="Home Image">
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                      <input class="form-control txtOnly" type="text" name="HomeHeading1"  id="first_heading" value="{{ $homeData->HomeHeading1 }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
