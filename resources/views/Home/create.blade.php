                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    <label for="first_image" class="col-sm-4 col-form-label">First Image <span style="color: red">*</span></label>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    <label for="first_heading" class="col-sm-4 col-form-label">First Heading <span style="color: red">*</span></label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control txtOnly" type="text" name="HomeHeading1" placeholder="First Heading" id="first_heading" required>
                                                        {{-- @error('first_heading')
