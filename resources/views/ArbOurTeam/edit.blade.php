                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('ArbOurTeamUpdate' , $ArbOurTeam->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                          <div class="col-xl-10">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="file" class="form-control-file mt-2" id="" name="ArbTeamImg">
                                                    @if($ArbOurTeam->ArbTeamImg)
                                                    <div style="width: 100px; height: auto;" class="homeimage mt-3">
                                                        <img src="/ArbOurTeamImg/{{ $ArbOurTeam->ArbTeamImg }}" style="width: 100%; border-radius: 10%;" alt="TeamImage">
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                      <textarea class="form-control txtOnly" type="text" name="ArbTeamPeragraph"    required>{{ $ArbOurTeam->ArbTeamPeragraph }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                      <input class="form-control txtOnly" type="text" name="ArbTeamHeading"   value="{{ $ArbOurTeam->ArbTeamHeading }}" required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                      <input class="form-control txtOnly" type="text" name="ArbTeamPost"   value="{{ $ArbOurTeam->ArbTeamPost }}" required> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-3 w-100"> <!-- Adjusted width to 100% and centered -->
                                            <button type="submit" class="btn btn-primary edit-team">تحديث</button>
