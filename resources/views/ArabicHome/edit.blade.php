                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="btn-group float-right">
                                    <ol class="breadcrumb hide-phone p-0 m-0">
                                        ...
                                        <li class="breadcrumb-item active"><a href=" ">بيت</a></li>
                                    </ol>
                                </div>
                                <h4 class="page-title">تحديث الصفحة الرئيسية</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">تحديث الصفحة الرئيسية</h4>
                                        ...
                                        <div class="row">
                                          <div class="col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="file" class="form-control-file mt-2" id="first_image" name="ArbHomeImg1">
                                                    @if($ArbhomeData->ArbHomeImg1)
                                                    <div style="width: 100px; height: auto;" class="homeimage mt-3">
                                                        <img src="/ArabicHomeImag/{{ $ArbhomeData->ArbHomeImg1 }}" style="width: 100%; border-radius: 10%;" alt="Home Image">
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                      <input class="form-control txtOnly" type="text" name="ArbHomeHeading1"  id="first_heading" value="{{ $ArbhomeData->ArbHomeHeading1 }}" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-3 w-100"> <!-- Adjusted width to 100% and centered -->
                                            <button type="submit" class="btn btn-primary edit-arb-home">تحديث</button>
...
<script>
document.querySelector('.edit-arb-home').addEventListener('click', event => {
