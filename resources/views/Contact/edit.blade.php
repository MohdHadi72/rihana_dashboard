                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('ContactUpdate', $ContactEdit->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{----}}
                                        <div class="row">
                                          <div class="col-xl-10">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="Number" id="Number" value="{{$ContactEdit->Number}}" required>
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control txtOnly" type="text" name="Address" value="{{$ContactEdit->Address}}" id="Address" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control enailOnly" type="email" name="Email"value="{{$ContactEdit->Email}}" id="Emal" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-3 w-100"> <!-- Adjusted width to 100% and centered -->
                                            <button type="submit" class="btn btn-primary edit-Contact">Update</button>
                                        </div>
                                        </div>
                                    </form>
